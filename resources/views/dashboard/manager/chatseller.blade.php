                    ...
                    <div class="position-sticky">
                        <ul class="nav flex-column">
                            ...
                            @foreach ($idmessage as $row)
                                <li class="nav-item">
                                    <a class="nav-link"
                                        href="{{ url('manager/messageseller/sellerId=' . $row->id_seller) }}">
                                        <span class="ml-2">{{ $i++ }}. {{ $row->seller->firstname }}
                                            {{ $row->seller->lastname }}</span>
                                    </a>
                                </li>
                            @endforeach
                                    ...
                                    <div class="container p-0">
                                        <div class="card">
                                            ...
                                            <div class="flex-grow-0 py-3 px-4 border-top">
                                                <form class="d-flex"
                                                    action="{{ route('manager.messagechartseller',['id' => $row->id_seller]) }}" method="post"
