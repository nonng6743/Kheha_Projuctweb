...
<head>
    ...
    <title>Manager Createpromotion</title>
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="col-12 col-xl mb-4 mb-lg-0">
                    <div class="card">
                        ...
                        <form action="{{ route('manager.createpromotion') }}" class="form-contact" method="post"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 py-2">
                                        <label for="image" class="fg-grey">อัพโหลดรูปภาพโปรโมชั่นสำหรับเว็บ</label>
                                    ...
                                    <div class="col-12 mt-3">
                                        <button type="submit" class="btn btn-primary px-5">อัพโหลด</button>
                                    </div>
                                </div>
                            </div>
                        </form>
