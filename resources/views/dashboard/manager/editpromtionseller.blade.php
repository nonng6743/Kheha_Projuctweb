                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">โปรโมชั่นจากร้านค้า</th>
                                        <th scope="col">อัพโปรโมชั่น</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @php($i = 1)
                                    @foreach ($promotionseller as $row)
                                        <tr>
                                            ...
                                            <td><a href="{{url('manager/updatestatuspromotor/'.$row->id)}}" class="btn btn-warning"  onclick="return confirm('คุณต้องการอัพโปรโมชั่นร้านค้าขึ้นหน้าเว็บหรือไม่ ?')">อัพโปรโมชั่น</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
