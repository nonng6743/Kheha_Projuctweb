        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navbarContent">
                <ul class="navbar-nav ml-auto pt-3 pt-lg-0">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('seller.login') }}" class="nav-link">เข้าสู่ระบบร้านค้า</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('seller.register') }}" class="nav-link ">สมัครสมาชิกเป็นร้านค้า</a>
                    </li>
    ...
    <div class="page-section">
        <div class="container">
            <div class="text-center">
                <h3 class="title-section mb-3">สมัครเพื่อขายสินค้ากับเรา</h3>
            </div>
            <div class="row justify-content-center mt-5">
                <div class="col-lg-8">
                    <form action="{{ route('seller.create') }}" class="form-contact" method="post" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 py-2">
                                ...
                                <select class="form-control" type="gender" id="gender" name="gender"  value="{{ old('gender') }}">
                                    <option value=""></option>
                            ...
                            <div class="col-sm-6 py-2">
                                <label for="birthdey	" class="fg-grey">ระบุวันเกิดของท่าน</label>
                                <input type="date" class="form-control" id="birthdey" name="birthdey"
                                      value="{{ old('birthdey') }}">
                                <span class="text-danger">@error('birthdey'){{ $message }} @enderror</span>
                            </div>
                            <div class="col-sm-6 py-2">
                                <label for="IDCard" class="fg-grey">รหัสบัตรประชาชน</label>
                                <input type="number" class="form-control" id="IDCard" name="IDCard"
                                    placeholder="รหัสบัตรประชาชนของท่าน"  value="{{ old('IDCard') }}">
