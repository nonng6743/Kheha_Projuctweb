...
<head>
    ...
    <title>Seller HomeMessage</title>
                    ...
                    <div class="position-sticky">
                        <ul class="nav flex-column">
                            ...
                            @foreach ($idmessage as $row)
                                <li class="nav-item">
                                    <a class="nav-link"
                                        href="{{ url('seller/messageuser/userId=' . $row->id_user) }}">
                                        <span class="ml-2">{{ $i++ }}. {{ $row->user->firstname }}
                ...
                <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                    <nav aria-label="breadcrumb">
                        ...
                        <div class="col-12 col-xl mb-4 mb-lg-0">
                            <div class="card">
                                <h5 class="card-header">ข้อความการติดต่อจาก {{ $row->user->firstname }}
                                    {{ $row->user->lastname }}</h5>
                                <div class="card-body ">
                                    <div class="container p-0">
                                        <div class="card">
                                            ...
                                            <div class="flex-grow-0 py-3 px-4 border-top">
                                                <form class="d-flex"
                                                    action="{{ route('seller.messagechatuser', ['id' => $row->id_user]) }}"
