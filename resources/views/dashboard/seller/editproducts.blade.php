...
<head>
    ...
    <title>Seller EditProduct</title>
                ...
                <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">เเก้ไขสินค้าของคุณ</li>
                        </ol>
                    </nav>
                    <h1 class="h2">เเก้ไขสินค้าของคุณ</h1>
                    <br>
                    <div class="col-12 col-xl mb-4 mb-lg-0">
                        <div class="card">
                            <h5 class="card-header">ข้อมูลรายละเอียดการเเก้ไขสินค้าของคุณ</h5>
                            <div class="card-body">
                                <form action="{{ url('/seller/updateproduct/' . $product->id) }}"
                                    class="form-contact" method="post" autocomplete="off"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 py-2">
                                            <label for="detail" class="fg-grey">รายละเอียดสินค้า</label>
                                        ...
                                        <div class="col-12 py-2">
                                            ...
                                            <img src="/images/products_seller/{{ $product->image }}" alt=""
                                                width="200px" height="200px" >
                                        </div>
                                        <br>
                                        <div class="col-12 mt-3">
                                            <button type="submit" class="btn btn-primary px-5">อัพเดต</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
