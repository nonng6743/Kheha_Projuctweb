                ...
                <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                    ...
                    <div class="row my-4">
                        <div class="col-12 col-md-6 col-lg-3 mb-4 mb-lg-0">
                            <div class="card">
                                <h5 class="card-header">จำนวนสินค้าของคุณ</h5>
                                <div class="card-body">
                                    <h4 class="card-title">{{$countproduct}}</h4>
                                    <p class="card-text">จำนวนสินค้าทั้งหมดของคุณ</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th scope="row">{{$i++}}</th>
                                                    <td><img src="/images/products_seller/{{ $row->image }}" alt=""
